...
<body>
                ...
                <div class="flex gap-4 mb-12 md:flex-row flex-col">
                    <div class="mb-5 flex flex-col md:w-1/2 w-full">
                        ...
                        <div class="flex flex-col items-center">
                            <?php if ($_SESSION['user']['user_status'] == 'complete') : ?>
                                <img src="../../assets/img/userdata/<?php echo $row['user_photo']; ?>?timestamp=<?php echo time(); ?>" class="h-28 mb-5" id='blah' alt="user_profile">
                            <?php endif; ?>
                    ...
                    <div class="mb-5 flex flex-col md:w-1/2 w-full relative">
                        ...
                        <div class="flex flex-col items-center">
                            <?php if ($_SESSION['user']['user_status'] == 'complete') : ?>
                                <img src="../../assets/img/userdata/<?php echo $row['user_identity_card']; ?>?timestamp=<?php echo time(); ?>" class="h-28 mb-5" id='blah1' alt="identity_card">
                            <?php endif; ?>
    ...
    <script>
        window.addEventListener('DOMContentLoaded', () => {
            ...
            identityCardInput.addEventListener('change', (evt) => {
                const [file] = evt.target.files;
                if (file) {
